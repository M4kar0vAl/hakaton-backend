...
from core.apps.articles.models import Article, CommunityArticle
...
class CommunityArticleRetrieveTestCase(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.published_community_article, cls.unpublished_community_article = CommunityArticle.objects.bulk_create([
            CommunityArticle(
                title='asfa',
                excerpt='asfaegk',
